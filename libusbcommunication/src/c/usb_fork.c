...
Java_com_mxtech_usb_LibusbCommunication_nativeInit(JNIEnv *env, jobject thiz, jint fd, jlongArray handle) {
...
Java_com_mxtech_usb_LibusbCommunication_nativeClose(JNIEnv *env, jobject thiz, jlong handle, jint interfaceNumber) {
...
JNIEXPORT jint JNICALL
Java_com_mxtech_usb_LibusbCommunication_nativeClaimInterface(JNIEnv *env, jobject thiz, jlong handle, jint interfaceNumber) {
...
JNIEXPORT jint JNICALL
Java_com_mxtech_usb_LibusbCommunication_nativeBulkTransfer(JNIEnv *env, jobject thiz, jlong handle,
...
JNIEXPORT jint JNICALL
Java_com_mxtech_usb_LibusbCommunication_nativeControlTransfer(JNIEnv *env, jobject thiz, jlong handle,
...
JNIEXPORT jint JNICALL
Java_com_mxtech_usb_LibusbCommunication_nativeReset(JNIEnv *env, jobject thiz, jlong handle) {
    LOG_W(TAG, "libusb reset");
    return libusb_reset_device((libusb_device_handle*)(intptr_t)handle);
}

JNIEXPORT jint JNICALL
Java_com_mxtech_usb_LibusbCommunication_nativeClearHalt(JNIEnv *env, jobject thiz, jlong handle, jint endpointAddress) {
